...
<body class="custom-cursor">
                        ...
                        <div class="footer-widget__column footer-widget__gallery clearfix">
                            ...
                            <ul class="footer-widget__gallery-list list-unstyled clearfix">
							 ...
							 <li> <a href="{{'services'}}">Services</a></li>
							  ...
							  <li><a href="{{'verifications'}}">All verifications</a></li>
							  <li><a href="www.admin.ivrfi.com">Login</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="site-footer__bottom-inner">
                            <p class="site-footer__bottom-text">© All Copyright 2022 by <a href="#">www.atriviastechnologies.com</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.blade.php" aria-label="logo image"><img src="assets/images/resources/logo-2.png" width="143"
                        alt="" /></a>
            </div>
            <!-- /.logo-box -->

            ...
            <div class="container">
                <div class="page-header__inner">
                    <ul class="thm-breadcrumb list-unstyled">
                        ...
                        <li><span>/</span></li>
                        <li>Academic checks</li>
                    </ul>
                    <h2>Academic checks</h2>
                </div>
            </div>
        </section>
        <!--Page Header End-->
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="services-one__single">
                            ...
                            <div class="service-one__content">
                                ...
                                <h2 class="service-one__title"><a href="class10.blade.php">Class X marksheet</a></h2>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="services-one__single">
                            ...
                            <div class="service-one__content">
                                ...
                                <h2 class="service-one__title"><a href="class12.blade.php">Class XII marksheet</a></h2>
                                <p class="service-one__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    elit.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="services-one__single">
                            ...
                            <div class="service-one__content">
                                ...
                                <h2 class="service-one__title"><a href="graduation.blade.php">Graduation Marksheet</a></h2>
                                <p class="service-one__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    elit.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="services-one__single">
                            ...
                            <div class="service-one__content">
                                ...
                                <h2 class="service-one__title"><a href="postgraduation.blade.php">Post Graduation Marksheet</a></h2>
                                <p class="service-one__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    elit.</p>
                            </div>
                        </div>

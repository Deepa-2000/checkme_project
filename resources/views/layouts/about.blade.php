@include('components.header')
                ...
                <div class="col-xl-6">
                    <div class="about-four__right">
                        <div class="section-title text-left">
                            ...
                            <h2 class="section-title__title">Creating a better future for your employment</h2>
                        </div>
                        ...
                        <div class="about-four__founder">
                            ...
                            <div class="about-four__founder-content">
                                ...
                                <p class="about-four__founder-sub-title">Founder of Lynx360</p>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<section>
	<div>
	<h2 style="margin-left:570px;">Our Vision<h2>
	<p class="about-four__text-2" style="margin-left:250px;">To be the global benchmark in products and solutions that build trust in people and alliances</p>
	</div>
	</section>
           <!--CTA One Start-->
                ...
                <div class="cta-one__inner">
                    ...
                    <div class="cta-one__right">
                        ...
                        <div class="cta-one__btn-box">
                            <a href="contact.blade.php" class="thm-btn cta-one__btn">Get a Quote</a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                    <div class="team-one__single">
                        ...
                        <div class="team-one__content">
                            ...
                            <h3 class="team-one__name"><a href="team-details.blade.php">Thomas Jakson</a></h3>
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                    <div class="team-one__single">
                        ...
                        <div class="team-one__content">
                            <p class="team-one__sub-title">Manager</p>
                            <h3 class="team-one__name"><a href="team-details.blade.php">Hallen Smith</a></h3>
                            <ul class="list-unstyled team-one__social-two">
                                <li><a href="#"><i class="fas fa-share-alt"></i></a></li>
                            </ul>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                    <div class="team-one__single">
                        ...
                        <div class="team-one__content">
                            <p class="team-one__sub-title">Manager</p>
                            <h3 class="team-one__name"><a href="team-details.blade.php">David Cooper</a></h3>
                            <ul class="list-unstyled team-one__social-two">
                                <li><a href="#"><i class="fas fa-share-alt"></i></a></li>
                            </ul>
                        </div>

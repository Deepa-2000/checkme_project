                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                        <div class="services-one__single">
                            ...
                            <div class="service-one__content">
                                ...
                                <h2 class="service-one__title"><a href="aadhar.blade.php">Aadhar Verification</a></h2>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="services-one__single">
                            ...
                            <div class="service-one__content">
                                ...
                                <h2 class="service-one__title"><a href="pan.blade.php">PAN Verification</a></h2>
                                <p class="service-one__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    elit.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="services-one__single">
                            ...
                            <div class="service-one__content">
                                ...
                                <h2 class="service-one__title"><a href="dl.blade.php">DL verification</a></h2>
                                <p class="service-one__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    elit.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                        <div class="services-one__single">
                            ...
                            <div class="service-one__content">
                                ...
                                <h2 class="service-one__title"><a href="passport.blade.php">Passport Verification</a></h2>
                                <p class="service-one__text">Lorem ipsum dolor sit amet, sed consectetur adipiscing
                                    elit.</p>
                            </div>
                        </div>

        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    ...
                    <h2>Parmanent Address Verification</h2>
                </div>
            </div>
        </section>
        <!--Page Header End-->
                        ...
                        <div class="why-choose-two__left">
                            <div class="section-title text-left">
                                <div class="section-sub-title-box">
                                    <p class="section-sub-title">Parmanent Address Verification beenfits</p>
                                ...
                                <h2 class="section-title__title">Why is parmanent address verification
                                    important?</h2>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="benefits-two__right">
                            <div class="section-title text-left">
                                <div class="section-sub-title-box">
                                    <p class="section-sub-title">Verification beenfits</p>
                                    <div class="section-title-shape-1">
                                        <img src="assets/images/shapes/section-title-shape-1.png" alt="">
                                    </div>
                                    <div class="section-title-shape-2">
                        ...
                        <div class="col-xl-12">
                            <div class="feature-four__top-inner">
                                <div class="feature-four__top-call">
                                    <div class="feature-four__top-call-box">
                                        <div class="feature-four__top-call-number-box float-bob-y">
                                            <a href="tel:9200368090">+91 (003) 68-090</a>
                                        </div>
                                ...
                                <div class="feature-four__top-content">
                                    <h3 class="feature-four__top-title">Talk to our experts</h3>
                                    ...
                                    <div class="feature-four__top-btn-box">
                                        <a href="about.blade.php" class="thm-btn feature-four__top-btn">Get Verified Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>

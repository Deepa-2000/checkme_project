                        ...
                        <div class="why-choose-two__left">
                            <div class="section-title text-left">
                                <div class="section-sub-title-box">
                                    <p class="section-sub-title">Class XII Marksheet checks beenfits</p>
                                ...
                                <h2 class="section-title__title">Why is Class XII Marksheet checks
                                    important?</h2>
                            </div>
